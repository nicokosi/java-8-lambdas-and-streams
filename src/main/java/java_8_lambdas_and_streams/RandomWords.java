...
public class RandomWords {
  ...
  public RandomWords() throws IOException {   
    try (BufferedReader reader = Files.newBufferedReader(Paths.get("src/main/java/java_8_lambdas_and_streams/words"))) {
  ...
  public List<String> createList(int listSize) {
    ...
    List<String> wordList = rand.ints(0, sourceWords.size() - 1)
            .limit(listSize)
